        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/download.png" alt="logo" height="30px" width="30px"></a> <span class="logo-text">Food system</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
